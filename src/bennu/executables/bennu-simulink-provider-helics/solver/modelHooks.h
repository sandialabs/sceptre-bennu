 ...
 *    init(mmi);
 *
 * TODO: Research 'System Outputs' vs 'System Update' custcode blocks
 * TODO: Research C++ S-Function wrappers
...
/* Currently unused, code is commented out in step function */
static const unsigned int DEBUG_PRINT_INTERVAL = 100;
